...
const Content = () => {
  const textNodes = [
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          description: "What an EIN is, Licenses, Zoning Permits, business bank accounts, etc.",
          requiredState: null,
          category: null,
          prevNodeId: 3,
          nextNodeId: 7,
    ...
    {
      nodeId: 5,
      question: "This would be describe the type of rental and lease agreement I need help with:",
      options: [
        {
      ...
      options: [
        {
          ...
          description: "A demand letter is a preliminary tactic used by individuals or entities as an attempt to resolve a dispute, usually over a form of payment owed by one party to another. These letters are an effort by one party involved in the dispute to reach a resolution before taking formal legal action through the courts.",
        ...
        description: `the use of methods such as ${<a href='https://corporate.findlaw.com/litigation-disputes/what-is-mediation-and-how-does-it-work.html'>mediation</a> } and ${<a href='https://www.dictionary.com/browse/arbitration'>arbitration</a> } to resolve a dispute instead of litigation.`,
          requiredState: null, // if(options.category == "conflict") { prevNode = 3, nextNodeId = 0 }
          category: "resolution",
          prevNodeId: 6,
          nextNodeId: 0,
        ...
        {
          text: "Litigation",
          description: " Ultimate legal method for settling controversies or disputes between and among persons, organizations, and the State.",
          requiredState: null, // if(options.category == "conflict") { prevNode = 3, nextNodeId = 0 }
          category: "litigation",
          prevNodeId: 6,
          nextNodeId: 0,
    ...
    },
    {
      ...
      options: [
        {
          text: "EIN",
          description: "An Employer Identification Number (EIN) is a unique identification number that is assigned to a business entity so that it can easily be identified by the Internal Revenue Service (IRS). 1﻿ It is commonly used by employers for the purpose of reporting taxes.",
          requiredState: null,
          category: null,
          prevNodeId: 7,
          nextNodeId: 0,
        },
        {
          ...
          description: `Licenses required for starting a business, more information can be found ${<a href="https://www.orcity.org/economicdevelopment/business-licenses">here</a>}.`,
          requiredState: null,
          category: null,
          prevNodeId: 7,
          nextNodeId: 0,
        },
        {
          ...
          description: `All your zoning license and permit needs can be found ${<a href="https://www.orcity.org/library/permits-licenses-and-zoning">here</a>}.`,
          requiredState: null,
          category: null,
          prevNodeId: 7,
          nextNodeId: 0,
        },
        {
          ...
          description: `More information on this topic can be found ${<a href="https://www.patriotsoftware.com/blog/accounting/do-need-separate-business-bank-account/#:~:text=You%20need%20a%20bank%20account,business%20as%20(DBA)%20name.&text=If%20you%20operate%20as%20a,open%20a%20business%20bank%20account.">here</a>}.`,
          requiredState: null,
          category: null,
          prevNodeId: 7,
          nextNodeId: 0,
